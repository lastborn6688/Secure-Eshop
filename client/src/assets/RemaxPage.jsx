...
const Remax = () => {
  return (
<div name="remaxProductPage" className="bg-[rgb(217,224,231)] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mt-0 lg:mt-20 gap-3">
      {remaxProduct.map((product, index) => (
        <div
          key={index}
