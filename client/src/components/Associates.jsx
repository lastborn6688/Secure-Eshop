...
const Associates = () => {
  return (
    <div className="min-h-[80vh] flex flex-col lg:flex-row items-center gap-10 justify-center bg-gradient-to-b from-[rgb(41,78,114)] to-[rgb(102,179,165)] text-white w-full px-6 py-10">
